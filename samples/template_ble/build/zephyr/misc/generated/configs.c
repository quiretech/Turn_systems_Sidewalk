...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 247);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOOKUP_CACHE_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_NRFX_RAM_BUFFER_SIZE, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ECC_TWISTED_EDWARDS_255, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ECC_SECP_R1_256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ALG_PURE_EDDSA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_WANT_ALG_ANY_ECDSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_CTR_DRBG_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_AES_CCM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_AES_GCM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_AEAD_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_AES_CTR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_AES_ECB_NO_PADDING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_CHACHA20, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_CIPHER_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDH_P256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDH_X25519, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDH_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDSA_P256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDSA_ED25519, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_ECDSA_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_DETERMINISTIC_ECDSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_RANDOMIZED_ECDSA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_P256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_SECP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_X25519, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_ED25519, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_25519, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_OBERON_KEY_PAIR_DRIVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_LINK_MASK_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_THREAD_STACK_SIZE, 8192);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_THREAD_QUEUE_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_THREAD_PRIORITY, 14);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_HEAP_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_LOG_MSG_LENGTH_MAX, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_CRYPTO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_CRYPTO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADAPTER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADAPTER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_BUS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_BUS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAC_ADDRESS_TYPE_RANDOM_PRIVATE_RESOLVABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADV_INT_PRECISION, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADV_INT_FAST, 160);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADV_INT_SLOW, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE_ADV_INT_TRANSITION, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DFU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DFU_SERVICE_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DEFAULTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BUILD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_ASSERT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_CRYPTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_LOG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_GENERATE_VERSION_MINIMAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_MFG_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_TIMER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_UPTIME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_CRITICAL_REGION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_CRITICAL_REGION_RE_ENTRY_MAX, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_ACE_OSAL_ZEPHYR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_SW_INTERRUPTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DELAY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_SWI_PRIORITY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_SWI_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_GPIO_IRQ_PRIORITY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_GPIO_IRQ_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DFU_BOOTLOADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_DFU_SERVICE_BLE_DEFAULTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SIDEWALK_BUTTONS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STATE_NOTIFIER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STATE_NOTIFIER_HANDLER_MAX, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_FLAG_SETTINGS_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_UPLOAD_START_TIMEOUT, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DFU_UPLOAD_COMPLETE_TIMEOUT, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TURN_APP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SIDEWALK_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NVS_LOG_LEVEL_WRN, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_STATUS_HOOKS, 1);
